...
options = [
    ...
    Option("GitRepoDir", "/home/scottc/BRO/spool/repo", "string", Option.USER, False,
           "Directory to hold the (autogenerated) version control."),
    Option("GitRepo", "0", "bool", Option.USER, False,
           "Turn GIT version control on and off."),
    Option("GitPath", "/home/scottc/BRO/spool", "string", Option.USER, False,
           "Path to what files are under version control"),
    Option("GitDiff", "0", "bool", Option.USER, False,
           "When running 'install' print file diff to screen."),
    Option("GitSkipFileTypes", ".swp .bin", "string", Option.USER, False,
           "File types (endings) to skip when populating repo."),
    Option("GitSkipDirs", ".git spool bin logs", "string", Option.USER, False,
           "Directorys to skip from the repo base."),
